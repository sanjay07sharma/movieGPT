...
const VideoTitle = ({title, overview}) => {
  return (
    <div className="pt-[35%] md:pt-[20%] px-6 md:px-24 absolute text-white bg-gradient-to-r from from-black w-screen aspect-video ">
        ...
        <div className="my-4 md:my-0">
          ...
          <button className="hidden md:inline-block more-info bg-gray-400 hover:bg-gray-300 text-gray-600 font-medium py-2 px-4 rounded ml-2">
